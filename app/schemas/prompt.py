...
class PromptVersionCreate(BaseModel):
    prompt_text: str  = Field(..., min_length=10,  description="Full system prompt text")
    ...
    activate:    bool = Field(False,               description="If true, activate this version immediately")
